...
fun JsonValue.asObject(): Map<String, JsonValue>? = (this as? JsonValue.ObjectValue)?.values
fun JsonValue.asArray(): List<JsonValue>? = (this as? JsonValue.ArrayValue)?.values
fun JsonValue.asString(): String? = (this as? JsonValue.StringValue)?.value
